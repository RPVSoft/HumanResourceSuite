CREATE TABLE [dbo].[EmployeeAddress] (
    ...
    CONSTRAINT [FK_EmployeeAddress_Master_Country] FOREIGN KEY ([country]) REFERENCES [dbo].[Master] ([id]),
    CONSTRAINT [FK_EmployeeAddress_Master_State] FOREIGN KEY ([state]) REFERENCES [dbo].[Master] ([id])
);
